...
const getActiveBadgeStyles = (status: CreatorCampaign["activeStatus"]) =>
  status === "active"
  ...
  return (
    <div className="overflow-hidden rounded-[14px] bg-white p-3 shadow-[0_4px_14px_rgba(17,24,39,0.04)]">
      ...
      <div className="space-y-3 px-1 pb-1 pt-4">
        ...
        <Button
          type="button"
          onClick={() => router.push(`/dashboard/my-campaigns/${campaign._id}`)}
          className="h-[42px] w-full rounded-full bg-gradient-to-r from-[#8C5CFF] to-[#7C5CFF] text-sm font-medium text-white hover:from-[#7F51F5] hover:to-[#744CF2]"
        >
          View Details
        </Button>
      </div>
