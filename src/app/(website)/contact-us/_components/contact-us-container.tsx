        ...
        <div className='bg-[#F6FBFF]'>
            <div className='container grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 lg:gap-10 py-10 md:py-14 lg:py-20 '>
                <div className='md:col-span-1 h-full w-full flex flex-col justify-center '>
                    <p className='max-w-[520px] pb-6 text-base leading-[160%] text-[#616161] md:pb-8 md:text-lg'>
                        If you have any questions about our platform or simply want to say hello, please don&apos;t hesitate to reach out. We&apos;re always happy to assist.
                    </p>
                ...
                <div id='contact-form' className='md:col-span-1 pr-0 md:pr-2'>
