    ...
    <section className="w-full bg-[#edf3f4] py-12 px-4">
      <div className="mx-auto max-w-6xl">
        <div className="rounded-xl bg-gradient-to-r from-sky-500 to-purple-500 px-6 py-10 text-center shadow-md sm:px-10 sm:py-12">
          ...
          <h2 className="text-2xl font-semibold text-white sm:text-3xl lg:text-[32px]">
            How To Successfully Use Our Site
          </h2>

          <p className="mt-3 text-sm text-white/90 sm:text-base">
            We make it easy for both IP owners and industry professionals to navigate through our site
          </p>
