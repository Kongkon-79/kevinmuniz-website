...
const AboutOurPlatform = () => {
  return (
    <div className="py-6 md:py-12 lg:py-20 bg-white">
      <div className="container">
        <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold leading-normal text-[#131313] text-center pb-4">
          About Our Platform
        </h2>
...
export default AboutOurPlatform;
